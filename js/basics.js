...
console.log(window.location.pathname != "/loginDesign.php");
if(!window.mobilecheck()){
    if(window.location.pathname == "/kitchen.php" || window.location.pathname == "/loginDesign.php"){
        
    }else{
        location.href = 'https://carlosabiamer.000webhostapp.com/error.php';
    }
}
        var elementosCesta = [];
